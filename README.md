...
Pinger Demo is free and open-source. You can test it online at https://marmelab.com/atomic-crm-demo.
...
- ✉️ **Capture Emails**: CC Pinger Demo to automatically save communications as notes.
...
## Customizing Pinger Demo

To customize Pinger Demo, you will need TypeScript and React programming skills as there is no graphical user interface for customization. Here are some resources to assist you in getting started.
